...
{
    public partial class DisDataAccess : System.Web.UI.Page
    {
        ...
        {
            String connectionString = ConfigurationManager.ConnectionStrings["SilverCyanideConnectionString"].ConnectionString;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                lblStatus.Text = "No changes Undone";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (ds.HasChanges())
            {
                ...
                Cache.Insert("DATASET", ds, null, DateTime.Now.AddHours(24), System.Web.Caching.Cache.NoSlidingExpiration);
                GetDataFromCache();
                lblStatus.Text = "Changes are done in cache";
                lblStatus.ForeColor = System.Drawing.Color.Green;
            }
            else
            {
                lblStatus.Text = "No changes are done in cache";
                lblStatus.ForeColor = System.Drawing.Color.Red;
            }
